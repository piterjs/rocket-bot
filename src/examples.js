...
bot.global.text(
  ...
  b => {
    switch (b.conditions.captured.door) {
      case '1':
        return b.respond(`You win nothing 💔`);
      case '2':
        return b.respond(`You win a monkey 🐒`);
      case '3':
        return b.respond(`It's a new car!! 🚗`);
    }
  },
  { id: 'door-prize-award' }
);
...
//     } else {
//       return b.respond(
//         'Sorry, that only works in channels and private groups.'
//       );
//     }
...
bot.global.text(
  ...
  b => {
    ...
    switch (type) {
      case 'c':
        return b.respond(`You're in the #${name} public channel.`);
      case 'p':
        return b.respond(`You're in a private group called **${name}**.`);
      case 'l':
        return b.respond(`You're in a livechat channel.`);
      case 'd':
        return b.respond(`You're in a DM with me :hugging:`);
    }
  },
  {
    id: 'location-check'
